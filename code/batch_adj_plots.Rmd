...
```{r pca_batch, fig.width = 20, fig.height = 20}
...
```{r var_explain, fig.width = 20, fig.height = 5}
# set up dfs
...
```{r community_str, fig.width = 18, fig.height = 12}
...
```{r pca_plots, fig.width = 15, fig.height = 14}
# make the plots
spp_score <- spp_var %>%
...
```{r barplot , fig.width = 15, fig.height = 10}
...
```{r upset, fig.width = 15, fig.height = 10}
...
### Upset plot
```{r Upset DAA, fig.width = 15, fig.height = 10}
